...
public class ArbolBusqueda{ 
    ...
    private int heuristica1(String estado , String objetivo2){
        ...
        for(int x=0;x<estado.length();x++){
            if(estado.charAt(x) != objetivo2.charAt(x) ) //MIENTRAS QUE EL ESTADO SEA DISTINTO AL OBJETIVO INCRMENTA CONTADOR
                resultado++;
    ...
    private int heuristica2(String estado , String objetivo3){
        ...
        for(int i=0;i<estado.length();i++){
               numero1 =Character.getNumericValue(estado.charAt(i));if(estado.charAt(i) == ' ') numero1 = 0;//SI ENCUENTRA ESPACIO ES UN CERO
               numero2=Character.getNumericValue(objetivo3.charAt(i));if(objetivo3.charAt(i)== ' ')numero2=0;
    ...
    /*HEURISTICA 3-. POR COLUMNAS (SUMAS)*/
